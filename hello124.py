...
def modifyrecord():
    ...
    r=input('Enter sr.no you want to modify')
    s=csv.reader(f)
    s1=csv.writer(f1)
    for rec in s:
        if rec[0]==r:
...
def deleterecord():
    ...
    f1=open('temp.csv','w',newline='\r\n')
    f1=open('temp.csv','a',newline='\r\n')
    r=input('Enter Srno you want to delete')
    s=csv.reader(f)
    s1=csv.writer(f1)
    for rec in s:
        if rec[0]==r:
...
def search():
    ...
    r=input('Enter Srno you want to search')
    s=csv.reader(f)
    for rec in s:
        if rec[0]==r:
            print("Srno=",rec[0])
